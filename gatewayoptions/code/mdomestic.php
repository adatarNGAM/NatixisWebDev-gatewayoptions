		...
		<td align="left"><strong>Select Gateway Option:</strong></td> 
		 <td style="padding-left:1px"><select name="gatewayoption" id="gatewayoption" required="Please choose a Gateway Option.">
				<option selected="selected" value="-1">Please Choose&hellip;</option>						
					<option value="1" selected>Gateway Fund</option>								
					<option value="2">Gateway Equity Fund</option>														
...
$checkdateinDBmodifiedlast = fetchLastModifiedDate('1');  
...
$sql = "call ank23_ngam_spnGatewayOptionPortfolioStatistics(1);";
...
<form name="domesticLoginForm" method="post" id="domesticloginFormId" action='<?= $_SERVER['REQUEST_URI'] ?>' accept-charset='UTF-8'> 
    ...
    <table cellpadding="2" cellspacing="0" id="main_info" width="563">
      ...
      <tr>
        ...
        <td>
          <input name="txtphwoPut" type="text"  value="<?php print($txtphwoPut)?>" maxlength="20" id="txtphwoPut" />
      ...
      <tr>
        ...
        <td>
          <input name="txtwpospPut" type="text"  value="<?php print($txtwpospPut)?>" maxlength="20" id="txtwpospPut" />
      ...
      <tr>
        ...
        <td>
          <input name="txtdtewPut" type="text" value="<?php print($txtdtewPut)?>" maxlength="20" id="txtdtewPut" />
      ...
      <tr>
        ...
        <td>
          <input name="txtwpoacfPut" type="text"  value="<?php print($txtwpoacfPut)?>" maxlength="20" id="txtwpoacfPut" />
      ...
      <tr>
        ...
        <td>
          <input name="txtwpoacCall" type="text"  value="<?php print($txtwpoacCall)?>" maxlength="20" id="txtwpoacCall" />
          <span id="RequiredFieldValidator11" style="color:Red;display:none;">*</span>
        </td>
        <td>
          <input name="txtwpoacPut" type="text"  value="<?php print($txtwpoacPut)?>" maxlength="20" id="txtwpoacPut" />
...
echo '<div style="text-align:center; margin-right: 52%;font-weight:bold"><a style="text-decoration:none;" href="https://ngam.natixis.com/us/mutual-funds/gateway-fund/GATEX" target="_blank">Click here to view Gateway Fund Detail Page</a></div>';	
...
$sql = "SELECT  date_format(`date`, '%m/%d/%Y')  as gatewayOptionDate FROM ank23_ngam_gatewaystats gs, ank23_ngam_gatewaystatslabels gsl where gs.labelID = gsl.GatewayStatsLabelID  AND gs.labelID IN (1,2,3,4,5,6) order by gs.date desc limit 1";
$counter=0;
